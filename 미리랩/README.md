...
**사회 혼란도 / 정책 수용도 / 신청 의향**을 수치화하고, 정보 전파 경로와 개선안(쉬운글 변환 포함)을
보여줍니다.
...
- **SNS형 채팅방 + 전파 네트워크 그래프**: 시민 간 정보가 퍼지는 과정 시각화
- **개선 제안**: 정책 쉬운글 변환 + 구체적 개선안 자동 생성
- **AB 테스트 / 게시판**: 정책 수정 전후 비교, 문의 자동 답변
